...
#Updated the file path here to match the variable PackageName
$action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument '-ExecutionPolicy Bypass -File "C:\Program Files\_MEM\Data\winget-updater\winget-updater.ps1"'
